...
import Teddybot.modules.sql.global_bans_sql as gban_sql
import Teddybot.modules.sql.users_sql as user_sql
from Teddybot import DEV_USERS, OWNER_ID, dispatcher
