...
from Teddybot import OWNER_ID, arq, pbot
from Teddybot.utils.pluginhelpers import convert_seconds_to_minutes as time_convert
from Teddybot.utils.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    buttons.add(
        InlineKeyboardButton("Get More Help.", url=f"t.me/Hottie_Robot?start=start"),
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/97fae5e9dadfc90e723ef.jpg",
