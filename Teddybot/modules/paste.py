...
def get_user_list(__init__, key):
    with open("{}/Teddybott/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]


# enable logging
FORMAT = "[teddy] %(message)s"
logging.basicConfig(
...
LOGGER.info(
    "teddy bot is starting. | An suru Projects | Licensed under GPLv3."
)
LOGGER.info("Not affiliated to Tantei Wa Mou or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/SuruXmanager (t.me/sweetttu_1)")
